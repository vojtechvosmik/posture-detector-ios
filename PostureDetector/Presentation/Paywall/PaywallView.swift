...
struct PaywallView: View {
    ...
    private var hero: some View {
        VStack(spacing: 20) {
            PaywallGlowOrb(systemName: "crown.fill", tint: teal, size: 104)
    ...
    private var purchaseFooter: some View {
        VStack(spacing: 12) {
            Button(action: purchase) {
                ...
                .shadow(color: teal.opacity(0.5), radius: 16, y: 8)
            }
            .buttonStyle(PaywallPressableStyle())
        ...
        .background(
            LinearGradient(
                colors: [Color(red: 0.02, green: 0.05, blue: 0.05).opacity(0),
                         Color(red: 0.02, green: 0.05, blue: 0.05).opacity(0.85),
...
private struct PaywallAurora: View {
    ...
    var body: some View {
        ZStack {
            ...
            blob(Color(red: 0.07, green: 0.42, blue: 0.31), 400, x: animate ? -110 : -70, y: animate ? -300 : -360)
            blob(Color(red: 0.06, green: 0.34, blue: 0.42), 440, x: animate ? 150 : 110, y: animate ? -150 : -90)
            blob(Color(red: 0.05, green: 0.28, blue: 0.26), 360, x: animate ? -120 : -70, y: animate ? 280 : 340)
